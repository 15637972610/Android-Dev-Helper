...
public class HeaderAndFooterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void addFooterView(View view) {
        ...
        LogUtils.e("YouthMainHomeProjectFragment ","addFooterView -->mFootViews.size ="+mFootViews.size()+",getHeadersCount()="+getHeadersCount()+",getRealItemCount()="+getRealItemCount()+",footCount="+getFootersCount());
    ...
    public void removeFooterView(View view) {
        ...
        if (index != -1) {
            ...
            LogUtils.e("YouthMainHomeProjectFragment ","removeFooterView -->mFootViews.size ="+mFootViews.size()+",index="+index+",getHeadersCount()="+getHeadersCount()+",getRealItemCount()="+getRealItemCount()+",footCount="+getFootersCount());
