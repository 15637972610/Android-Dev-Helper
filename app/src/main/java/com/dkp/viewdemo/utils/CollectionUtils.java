        ...
        if (collection != null && values != null) {
            if (notNull) {
                try {
                    ...
                    LogUtils.e(TAG,  "addAll notNull");
                }
            } else {
                try {
                    return collection.addAll(values);
                } catch (Exception e) {
                    LogUtils.e(TAG,  "addAll");
                }
            }
        }
        return false;
